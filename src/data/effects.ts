...
const MAJOR_THREAT: Record<1 | 2 | 3 | 4 | 5, Tier3> = {
    1: [
        [
            { site: "Hub", count: 2 },
            { site: "Hidden Hub", count: 3 },
            { site: "Forsaken Hub", count: 2 },
        ],
        [
            { site: "Hub", count: 3 },
            { site: "Hidden Hub", count: 3 },
            { site: "Forsaken Hub", count: 2 },
            { site: "Forlorn Hub", count: 2 },
            { site: "Haven", count: 1 },
        ],
        [
            { site: "Hub", count: 4 },
            { site: "Hidden Hub", count: 3 },
            { site: "Forsaken Hub", count: 3 },
            { site: "Forlorn Hub", count: 3 },
            { site: "Haven", count: 2 },
        ],
    ],
    2: [
        [
            { site: "Hub", count: 2 },
            { site: "Hidden Hub", count: 2 },
            { site: "Forsaken Hub", count: 2 },
            { site: "Forlorn Hub", count: 1 },
        ],
        [
            { site: "Hub", count: 2 },
            { site: "Hidden Hub", count: 3 },
    ...
    4: [
        ...
        [
            ...
            { site: "Forlorn Hub", count: 2 },
            { site: "Haven", count: 7 },
            { site: "Sanctum", count: 3 },
            { site: "Forsaken Sanctum", count: 1 },
        ],
    ],
    5: [
        [
        ...
        [
            ...
            { site: "Forlorn Hub", count: 2 },
            { site: "Haven", count: 8 },
            { site: "Sanctum", count: 4 },
            { site: "Forsaken Sanctum", count: 3 },
        ],
    ],
};
...
const MINOR_THREAT: Record<1 | 2 | 3 | 4 | 5, Tier3> = {
    1: [
        [
            { site: "Refuge", count: 2 },
            { site: "Den", count: 2 },
            { site: "Hidden Den", count: 1 },
        ],
        [
            { site: "Refuge", count: 1 },
            { site: "Den", count: 3 },
            { site: "Hidden Den", count: 1 },
            { site: "Forsaken Den", count: 1 },
            { site: "Forlorn Den", count: 1 },
            { site: "Rally Point", count: 2 },
            { site: "Hidden Rally Point", count: 1 },
        ],
        [
            { site: "Refuge", count: 2 },
            { site: "Den", count: 4 },
            { site: "Hidden Den", count: 3 },
            { site: "Forsaken Den", count: 2 },
            { site: "Forlorn Den", count: 1 },
            { site: "Rally Point", count: 2 },
            { site: "Hidden Rally Point", count: 1 },
        ],
    ...
    2: [
        ...
        [
            ...
            { site: "Forlorn Den", count: 1 },
            { site: "Rally Point", count: 2 },
            { site: "Hidden Rally Point", count: 2 },
            { site: "Forsaken Rally Point", count: 1 },
        ],
    ],
    3: [
        [
        ...
        [
            ...
            { site: "Hidden Den", count: 2 },
            { site: "Forsaken Den", count: 2 },
            { site: "Forlorn Den", count: 2 },
            { site: "Rally Point", count: 2 },
            { site: "Hidden Rally Point", count: 1 },
            { site: "Forsaken Rally Point", count: 2 },
            { site: "Forlorn Rally Point", count: 1 },
        ],
    ],
    4: [
        [
        ...
        [
            ...
            { site: "Forsaken Den", count: 2 },
            { site: "Forlorn Den", count: 2 },
            { site: "Rally Point", count: 4 },
            { site: "Hidden Rally Point", count: 2 },
            { site: "Forsaken Rally Point", count: 2 },
            { site: "Forlorn Rally Point", count: 2 },
        ],
    ],
    5: [
        [
        ...
        [
            ...
            { site: "Forlorn Den", count: 2 },
            { site: "Rally Point", count: 2 },
            { site: "Hidden Rally Point", count: 3 },
            { site: "Forsaken Rally Point", count: 3 },
            { site: "Forlorn Rally Point", count: 3 },
        ],
    ],
};

const PROSPECTING_RE =
    /^(Tritanium|Pyerite|Mexallon|Isogen|Nocxium|Zydrine|Megacyte) Prospecting Array ([123])$/;
const THREAT_RE = /^(Major|Minor) Threat Detection Array ([123])$/;

export function siteEffectsFor(
    upgradeName: string,
    sec: number | null,
): SiteGrant[] {
    ...
    if (p) {
        ...
        const grants: SiteGrant[] = [
            { site: `Lvl ${tier} ${ore} Site`, count: 1 },
        ];
...
export function aggregateGrants(lists: SiteGrant[][]): SiteGrant[] {
    ...
    return Array.from(map, ([site, count]) => ({ site, count })).sort((a, b) =>
